...
const Biography = () => {
    return (
        <>
            ...
            <main id='Biography' className='medium-main-bio lg:hidden relative pt-6 md:pr-6 md:pl-6 md:mx-8 lg:mb-10 px-4'>
